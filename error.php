...
<html lang="en">
    <head>
        ...
        <title>Dietrich Architects | Error</title>
    </head>
    <body>
        ...
        <section class="container-fluid error-s1 d-flex">
            <div class="row my-auto mx-auto w-100 p-20 w-100">
        ...
        <footer class="container-fluid bg-blk text-white p-20">
            ...
            <div class="row text-center">
                <p>
                    ...
                    <a href="privacy.html" class="text-white link link-white">Privacy &amp; cookies</a>
                </p>
            </div>
        </footer> 
